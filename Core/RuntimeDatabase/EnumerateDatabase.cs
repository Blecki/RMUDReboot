    ...
    public partial class RuntimeDatabase : WorldDataService
    {
        ...
        private List<String> EnumerateGithubDatabase()
        {
            try
            {
                ...
                var githubClient = new Octokit.GitHubClient(new Octokit.ProductHeaderValue("Blecki"));
                ...
                var repos = new Octokit.RepositoryCollection();
                repos.Add(Core.SettingsObject.GithubRepo);
