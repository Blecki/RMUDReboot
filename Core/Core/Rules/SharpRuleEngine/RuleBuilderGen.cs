...
namespace SharpRuleEngine
{
	public class RuleBuilder<TR>
    {
        ...
        public RuleSource AssociatedObject = null;
		...
		public RuleBuilder<TR> Associate(RuleSource Object)
		{
	...
	public class RuleBuilder<T0, TR>
    {
		...
		public RuleBuilder<T0, TR> Associate(RuleSource Object)
		{
			this.AssociatedObject = Object;
			return this;
		}
	...
	public class RuleBuilder<T0, T1, TR>
    {
		...
		public RuleBuilder<T0, T1, TR> Associate(RuleSource Object)
		{
			this.AssociatedObject = Object;
			return this;
		}
	...
	public class RuleBuilder<T0, T1, T2, TR>
    {
		...
		public RuleBuilder<T0, T1, T2, TR> Associate(RuleSource Object)
		{
			this.AssociatedObject = Object;
			return this;
		}
	...
	public class RuleBuilder<T0, T1, T2, T3, TR>
    {
		...
		public RuleBuilder<T0, T1, T2, T3, TR> Associate(RuleSource Object)
		{
			this.AssociatedObject = Object;
			return this;
		}
